...
const reviews = [
  ...
  { id: 22, age: "20代後半", tenure: "2年目", text: "退職の連絡から手続きまで、まったく園と連絡を取らなくてよかったです。電話が来るかもとビクビクしていましたが、全て代わりに対応してくれて本当に安心でした。" },
  { id: 23, age: "30代前半", tenure: "4年目", text: "引き継ぎのことが一番心配でしたが、園との間に入って調整してくれました。子どもたちに迷惑をかけたくなかったので、丁寧に対応していただけて感謝しています。" },
  { id: 24, age: "20代前半", tenure: "3年目", text: "年度途中で辞めることに罪悪感がありましたが、園が困らないような提案をしてくれました。引き継ぎ資料の準備についてもアドバイスをもらえて、気持ちよく退職できました。" },
];
